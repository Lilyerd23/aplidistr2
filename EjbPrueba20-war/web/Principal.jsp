<%-- 
    Document   : Principal
    Created on : 12 set. 2020, 21:40:06
    Author     : alexandro
--%>
                    ...
                    <ul class='navbar-nav mr-auto'>
                        ...
                        <li class='nav-item dropdown active'>
                            ...
                            <div class='dropdown-menu bg-dark text-white' aria-labelledby='navbarDropdown'>
                                <a class='dropdown-item bg-dark text-white'  href='PostProducto'>Productos</a>
                                <a class='dropdown-item bg-dark text-white' href='PostEmpleado'>Empleados</a>
                                <a class='dropdown-item bg-dark text-white' href='PostProveedor'>Proveedores</a>
                                <div class='dropdown-divider'></div>
                                <a class='dropdown-item bg-dark text-white' href='#'>Ventas</a>
                                <a class='dropdown-item bg-dark text-white' href='#'>Detalle de Ventas</a>
                            </div>
                        </li>
                        <li class='nav-item dropdown active'>
                            <a class='nav-link dropdown-toggle' href='#' id='navbarDropdown' role='button' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                            ...
                            <div class='dropdown-menu bg-dark text-white' aria-labelledby='navbarDropdown'>
                                <a class='dropdown-item bg-dark text-white'  href='ListProducto'>Productos</a>
                                <a class='dropdown-item bg-dark text-white' href='ListEmpleado'>Empleados</a>
                                <a class='dropdown-item bg-dark text-white' href='ListProveedor'>Proveedores</a>
                                <div class='dropdown-divider'></div>
                                <a class='dropdown-item bg-dark text-white' href='ListClienteJuridico'>Clientes Juridicos</a>
                                <a class='dropdown-item bg-dark text-white' href='ListClienteNatural'>Clientes Naturales</a>
                                <div class='dropdown-divider'></div>
                                <a class='dropdown-item bg-dark text-white' href='#'>Ventas</a>
                                <a class='dropdown-item bg-dark text-white' href='#'>Detalle de Ventas</a>
                            </div>
