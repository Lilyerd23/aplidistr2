...
import ejb.ClienteNaturalEntidadFacade;
 ...
 * @author lily
 */
@WebServlet(name = "ListClienteNatural", urlPatterns = {"/ListClienteNatural"})
public class ListClienteNatural extends HttpServlet {

    @EJB
    private EjbSessionManagerBean ejbSessionManagerBean;

    @EJB
    private ClienteNaturalEntidadFacade ClienteNaturalEntidadFacade;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<th class='column1'>Apellidos</th>");
            ...
            out.println("<tbody>");
            out.println("<tr>");
            List emp=ClienteNaturalEntidadFacade.findAll();
            for (Iterator it = emp.iterator(); it.hasNext();){
                    ClienteNaturalEntidad elem= (ClienteNaturalEntidad) it.next();           
