...
import ejb.ProductoEntidadFacade;
...
public class ListProducto extends HttpServlet {
    ...
    @EJB
    private ProductoEntidadFacade ProductoEntidadFacade;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<th class='column1'>IDProveedor</th>");
            out.println("<th class='column1'>Nombre</th>");
            out.println("<th class='column1'>Cantidad</th>");
            out.println("<th class='column1'>Precio Compra</th>");
            out.println("<th class='column1'>Precio Venta</th>");
            ...
            out.println("<tbody>");
            out.println("<tr>");
            List emp=ProductoEntidadFacade.findAll();
            for (Iterator it = emp.iterator(); it.hasNext();){
                    ProductoEntidad elem= (ProductoEntidad) it.next();           
                    out.println("<td class='column1'>"+elem.getPoveedor()+"</td>");
                    out.println("<td class='column1'>"+elem.getNombre()+"</td>");
                    out.println("<td class='column1'>"+elem.getCantidad()+"</td>");  
                    out.println("<td class='column1'>"+elem.getPrecio_compra()+"</td>");
                    out.println("<td class='column1'>"+elem.getPrecio_venta()+"</td>");
