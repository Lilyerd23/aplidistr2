...
import ejb.ProveedorEntidadFacade;
 ...
 * @author lily
 */
@WebServlet(name = "ListProveedor", urlPatterns = {"/ListProveedor"})
public class ListProveedor extends HttpServlet {

    @EJB
    private EjbSessionManagerBean ejbSessionManagerBean;

    @EJB
    private ProveedorEntidadFacade ProveedorEntidadFacade;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<th class='column1'>Proveedor</th>");
            ...
            out.println("<tbody>");
            out.println("<tr>");
            List emp=ProveedorEntidadFacade.findAll();
            for (Iterator it = emp.iterator(); it.hasNext();){
                    ProveedorEntidad elem= (ProveedorEntidad) it.next();           
                    out.println("<td class='column1'>"+elem.getProveedor()+"</td>");
